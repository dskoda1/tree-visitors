...
public class Trie {
	...
	/**
	 * Insert the given string. This first checks if the word already occurs,
	 * and if it does then increments its count. If not, it iteratively goes
	 * through the characters in the new word and attempts to append it to the
	 * tree through either existing words that share a similar prefix, or
	 * creating new nodes.
	 * 
	 * @param insertMe
	 *            the word to insert
	...
	/**
	 * Returns an unsorted arraylist of all the words in the trie. ****We could
	 * optimize insert to store the words alphabetically and actually improve
	 * insert time, along with keep the words sorted in memory.**
	 * 
	...
	/**
	 * Given a node, traverses the parent links and constructs the word ending
	 * at that node
	 * 
	 * @param n
	 *            the node for which a word was requested.
